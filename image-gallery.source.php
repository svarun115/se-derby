...
<br>
    ...
    <script type="text/javascript" src="js1/jssor.js"></script>
	...
	<div class="row">
	<div class="well">
    <div id="slider1_container" style="position: relative; left:50px; width: 800px;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 356px; overflow: hidden;">
			...
			<div>
                <img u="image" src="img/13.jpeg" />
                <img u="thumb" src="img/thumb-13.jpeg" />
            </div>
			<div>
			...
			<div>
                <img u="image" src="img/15.jpg" />
                <img u="thumb" src="img/thumb-15.jpg" />
            </div>
			<div>
                <img u="image" src="img/16.jpg" />
                <img u="thumb" src="img/thumb-16.jpg" />
            </div>
			<div>
                <img u="image" src="img/17.jpg" />
                <img u="thumb" src="img/thumb-17.jpg" />
            </div>
			<div>
                <img u="image" src="img/18.jpg" />
                <img u="thumb" src="img/thumb-18.jpg" />
            </div>
			<div>
                <img u="image" src="img/19.jpg" />
                <img u="thumb" src="img/thumb-19.jpg" />
            </div>
			<div>
                <img u="image" src="img/20.jpg" />
                <img u="thumb" src="img/thumb-20.jpg" />
            </div>
			<div>
                <img u="image" src="img/21.jpg" />
                <img u="thumb" src="img/thumb-21.jpg" />
            </div>
			<div>
                <img u="image" src="img/22.jpg" />
                <img u="thumb" src="img/thumb-22.jpg" />
            </div>
			<div>
                <img u="image" src="img/23.jpg" />
                <img u="thumb" src="img/thumb-23.jpg" />
            </div>
			<div>
                <img u="image" src="img/24.jpg" />
                <img u="thumb" src="img/thumb-24.jpg" />
            </div>
			<div>
                <img u="image" src="img/25.jpg" />
                <img u="thumb" src="img/thumb-25.jpg" />
            </div>
			<div>
                <img u="image" src="img/26.jpg" />
                <img u="thumb" src="img/thumb-26.jpg" />
            </div>
			<div>
                <img u="image" src="img/27.jpg" />
                <img u="thumb" src="img/thumb-27.jpg" />
            </div>
			<div>
                <img u="image" src="img/28.jpg" />
                <img u="thumb" src="img/thumb-28.jpg" />
            </div>
			<div>
                <img u="image" src="img/29.jpg" />
                <img u="thumb" src="img/thumb-29.jpg" />
            </div>
			<div>
                <img u="image" src="img/30.jpg" />
                <img u="thumb" src="img/thumb-30.jpg" />
            </div>
        </div>
