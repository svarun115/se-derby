...
// call or define the Club table create functions here
			...
			mysqli_query($conn,$sql);
			$sql = " CREATE TABLE IF NOT EXISTS members ( member_id int(11) NOT NULL AUTO_INCREMENT, ph_no bigint(11) NOT NULL, name varchar(25) NOT NULL, gender varchar(1) NOT NULL, dob date NOT NULL,address varchar(50) NOT NULL,member_type int(11) NOT NULL,picture varchar(25) NOT NULL, Race_update DOUBLE(10, 4), PRIMARY KEY (member_id))";
			mysqli_query($conn,$sql);
			$sql = "CREATE TABLE IF NOT EXISTS racing_history ( race_id varchar(30), race_name varchar(30), race_date date,time varchar(25), category int NOT NULL,temperature double NOT NULL,humidity double NOT NULL,wind double NOT NULL,type int(1),winner varchar(30) NOT NULL,second_place varchar(30) NOT NULL,PRIMARY KEY (race_id))";
			mysqli_query($conn,$sql);
